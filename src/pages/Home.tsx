        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`flex items-center justify-center w-16 h-16 bg-blue-100 text-blue-700 rounded-lg mb-6 group-hover:bg-blue-700 group-hover:text-white transition-colors ${
          ...
          >
            ...
            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-2xl p-8">
              <div className={`text-center mb-8 ${isRTL ? "text-right" : ""}`}>
                <div
                  className={`inline-flex items-center text-yellow-500 mb-2 ${
              ...
              >
                <div
                  className={`flex items-center text-yellow-500 mb-4 ${
                    isRTL
                      ? "space-x-reverse space-x-1 justify-end"
                      : "space-x-1"
                  }`}
                >
