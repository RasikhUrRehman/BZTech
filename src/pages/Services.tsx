  ...
  const services = [
    {
      ...
      features: [
        t("service.feature.allLevels"),
        t("service.feature.variousSubjects"),
        t("service.feature.originalContent"),
        t("service.feature.properFormatting"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.researchProposal"),
        t("service.feature.literatureReview"),
        t("service.feature.methodologyDesign"),
        t("service.feature.dataAnalysis"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.originalResearch"),
        t("service.feature.peerReviewReady"),
        t("service.feature.citationIncluded"),
        t("service.feature.qualitySources"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.topicSelection"),
        t("service.feature.chapterWiseWriting"),
        t("service.feature.defensePreparation"),
        t("service.feature.revisionSupport"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.argumentativeEssays"),
        t("service.feature.narrativeEssays"),
        t("service.feature.descriptiveEssays"),
        t("service.feature.compareContrast"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.problemStatement"),
        t("service.feature.literatureGap"),
        t("service.feature.methodology"),
        t("service.feature.timeline"),
      ],
      price: t("common.free"),
      highlight: true,
      freeOffer: true,
    },
    {
      ...
      features: [
        t("service.feature.journalSelection"),
        t("service.feature.manuscriptPreparation"),
        t("service.feature.peerReviewSupport"),
        t("service.feature.publicationGuidance"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.oneOnOneSessions"),
        t("service.feature.assignmentWalkthrough"),
        t("service.feature.conceptClarification"),
        t("service.feature.studyGuidance"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.contentRewriting"),
        t("service.feature.originalityEnhancement"),
        t("service.feature.qualityImprovement"),
        t("service.feature.reportIncluded"),
      ],
    ...
    },
    {
      ...
      features: [
        t("service.feature.academicFormatting"),
        t("service.feature.citationStyles"),
        t("service.feature.proofreading"),
        t("service.feature.finalReview"),
      ],
  ...
  const freeServices = [
    {
      ...
      features: [
        t("service.feature.detailedReport"),
        t("service.feature.aiDetection"),
        t("service.feature.originalityVerification"),
        t("service.feature.qualityAssurance"),
      ],
      price: t("common.free"),
      highlight: true,
      freeOffer: true,
    },
    {
      ...
      features: [
        t("service.feature.topicConsultation"),
        t("service.feature.structureGuidance"),
        t("service.feature.resourceRecommendations"),
        t("service.feature.approachSuggestions"),
      ],
      price: t("common.free"),
      highlight: true,
      freeOffer: true,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allServices.map((service, index) => (
              <div
                key={index}
                className={`bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow border flex flex-col h-full ${
                  service.highlight
              ...
              >
                <div className="p-8 pb-4 flex-grow">
                  ...
                  <div
                    className={`flex items-center justify-center w-16 h-16 bg-blue-100 text-blue-700 rounded-lg mb-6 ${
            ...
            <div className={isRTL ? "text-right" : "text-left"}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  {
                    icon: Clock,
                    titleKey: "services.feature.onTimeDelivery.title",
                    descKey: "services.feature.onTimeDelivery.desc",
                  },
                  {
                    icon: CheckCircle,
                    titleKey: "services.feature.qualityGuaranteed.title",
                    descKey: "services.feature.qualityGuaranteed.desc",
                  },
                  {
                    icon: PenTool,
                    titleKey: "services.feature.originalWork.title",
                    descKey: "services.feature.originalWork.desc",
                  },
                  {
                    icon: Lightbulb,
                    titleKey: "services.feature.expertWriters.title",
                    descKey: "services.feature.expertWriters.desc",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
